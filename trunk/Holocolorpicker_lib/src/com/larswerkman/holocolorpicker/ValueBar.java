...
//					if(mBarPointerPosition<200){
					...
					invalidate();
			//		}
					System.out.println("ONE"+mBarPointerPosition);
					...
					invalidate();
					System.out.println("TWO"+mBarPointerPosition);
					...
					System.out.println("Three"+mBarPointerPosition);
				}
			}
			break;
